// Auto-generated API Payload & Response Types from user-auth-open-spec.yaml
// Generated on: 2026-04-15T11:44:30.914Z
...
export interface components {
    schemas: {
        User: {
            /** @example 69df3b4acd104a41687aa91e */
            _id: string;
            /** @example test */
            firstname: string;
            /** @example sharma */
            ...
            /**
             * Format: email
             * @example mantrydinesh@gmail.com
             */
            email: string;
            /** Format: uri */
...
export const UserCodec = t.intersection([
  ...
  t.partial({
  userprofile: t.union([t.string, t.null]),
  password: t.string,
...
export const VALIDATOR_MAP: Record<string, string> = {
  "POST /userauth/api/register": "RegisterUserResponseValidator"
};
...
// Register a new user
export type RegisterUserPayload = User;

// RegisterUserRequest type is available from schema exports above
...
export const RegisterUserResponseValidator = createApiValidator(UserCodec);
